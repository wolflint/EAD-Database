...
CREATE TABLE Employee(
	...
	HOMEPHONE VARCHAR2(12 BYTE) NOT NULL,
	MOBILEPHONE VARCHAR2(12 BYTE) NOT NULL,
	ADDRESSLINE1 VARCHAR2(30 BYTE) NOT NULL,
	...
	SKILLLEVEL NUMBER(*,0) NOT NULL, -- 0 not a dev, 1 low, 2 intermediate, 3 expert
	STARTDATE DATE NOT NULL,
	ENDDATE DATE,
	DOB DATE NOT NULL,
	CONTRACTTYPE VARCHAR2(10 BYTE) NOT NULL,
	WEEKLYHOURS NUMBER(2,0) NOT NULL,
	-- Specify the PRIMARY KEY constraint for table "Employee".
	CONSTRAINT	pk_Employee PRIMARY KEY (EMPLOYEEID)
);

-- Add check contraint for the CONTRACTTYPE field in the employee table
ALTER TABLE EMPLOYEE ADD CONSTRAINT "CONTRACT_CHK" CHECK ("CONTRACTTYPE" IN ('PART-TIME', 'FULL-TIME', 'CONTRACTOR')) ENABLE;
...
-- Insert initial data
Insert into EMPLOYEE (EMPLOYEEID,FIRSTNAME,LASTNAME,PAYRATE,HOMEPHONE,MOBILEPHONE,ADDRESSLINE1,ADDRESSLINE2,PROVINCE,CITY,POSTCODE,SKILLLEVEL,STARTDATE,ENDDATE,DOB,CONTRACTTYPE,WEEKLYHOURS) values (1,'Marcin','Wolf',15,'01827333990','079388279','123 Oracle Street',null,'Esquielle','Esquielle City','ES8H HJ8',2,to_date('06-MAY-19','DD-MON-RR'),null,to_date('01-JAN-97','DD-MON-RR'),'FULL-TIME',40);
Insert into EMPLOYEE (EMPLOYEEID,FIRSTNAME,LASTNAME,PAYRATE,HOMEPHONE,MOBILEPHONE,ADDRESSLINE1,ADDRESSLINE2,PROVINCE,CITY,POSTCODE,SKILLLEVEL,STARTDATE,ENDDATE,DOB,CONTRACTTYPE,WEEKLYHOURS) values (2,'Ben','Bishop',15,'01828739478','078389278','124 Oracle Street',null,'Esquielle','Esquielle City','ES8H HJ8',2,to_date('06-MAY-19','DD-MON-RR'),null,to_date('01-JAN-97','DD-MON-RR'),'FULL-TIME',40);
Insert into EMPLOYEE (EMPLOYEEID,FIRSTNAME,LASTNAME,PAYRATE,HOMEPHONE,MOBILEPHONE,ADDRESSLINE1,ADDRESSLINE2,PROVINCE,CITY,POSTCODE,SKILLLEVEL,STARTDATE,ENDDATE,DOB,CONTRACTTYPE,WEEKLYHOURS) values (3,'Sahmed','Guzil',15,'01823478923','073289478','125 Oracle Street',null,'Esquielle','Esquielle City','ES8H HJ8',2,to_date('06-MAY-19','DD-MON-RR'),null,to_date('01-JAN-97','DD-MON-RR'),'FULL-TIME',40);
Insert into EMPLOYEE (EMPLOYEEID,FIRSTNAME,LASTNAME,PAYRATE,HOMEPHONE,MOBILEPHONE,ADDRESSLINE1,ADDRESSLINE2,PROVINCE,CITY,POSTCODE,SKILLLEVEL,STARTDATE,ENDDATE,DOB,CONTRACTTYPE,WEEKLYHOURS) values (4,'Alex','Wood',15,'01827389278','078234897','126 Oracle Street',null,'Esquielle','Esquielle City','ES8H HJ8',2,to_date('06-MAY-19','DD-MON-RR'),null,to_date('01-JAN-97','DD-MON-RR'),'FULL-TIME',40);
Insert into EMPLOYEE (EMPLOYEEID,FIRSTNAME,LASTNAME,PAYRATE,HOMEPHONE,MOBILEPHONE,ADDRESSLINE1,ADDRESSLINE2,PROVINCE,CITY,POSTCODE,SKILLLEVEL,STARTDATE,ENDDATE,DOB,CONTRACTTYPE,WEEKLYHOURS) values (5,'Jim','Canfixit',15,'01823748937','023487938','12345 Fix It Road',null,'Shire','Hobbiton','SH89 HJ8',2,to_date('07-JUN-19','DD-MON-RR'),null,to_date('01-JAN-97','DD-MON-RR'),'PART-TIME',16);
Insert into EMPLOYEE (EMPLOYEEID,FIRSTNAME,LASTNAME,PAYRATE,HOMEPHONE,MOBILEPHONE,ADDRESSLINE1,ADDRESSLINE2,PROVINCE,CITY,POSTCODE,SKILLLEVEL,STARTDATE,ENDDATE,DOB,CONTRACTTYPE,WEEKLYHOURS) values (6,'Scott','Cantfixit',8.2,'01827389737','0187398734','1234 Button Street',null,'Mordor','Birmingham','B87 223',1,to_date('15-NOV-19','DD-MON-RR'),null,to_date('01-JAN-97','DD-MON-RR'),'FULL-TIME',40);
Insert into EMPLOYEE (EMPLOYEEID,FIRSTNAME,LASTNAME,PAYRATE,HOMEPHONE,MOBILEPHONE,ADDRESSLINE1,ADDRESSLINE2,PROVINCE,CITY,POSTCODE,SKILLLEVEL,STARTDATE,ENDDATE,DOB,CONTRACTTYPE,WEEKLYHOURS) values (7,'Robert','Boss',40,'96788969878','8976876877','123 Paintbrush Road',null,'Acrylic','Blue','AB78 78',3,to_date('25-DEC-19','DD-MON-RR'),null,to_date('01-JAN-97','DD-MON-RR'),'FULL-TIME',40);
Insert into EMPLOYEE (EMPLOYEEID,FIRSTNAME,LASTNAME,PAYRATE,HOMEPHONE,MOBILEPHONE,ADDRESSLINE1,ADDRESSLINE2,PROVINCE,CITY,POSTCODE,SKILLLEVEL,STARTDATE,ENDDATE,DOB,CONTRACTTYPE,WEEKLYHOURS) values (8,'Aaragorn','King',15,'7892347988','47839289732','123 Gondor Palace',null,'Gondor','Gondor','G78 87',2,to_date('26-DEC-19','DD-MON-RR'),null,to_date('01-JAN-97','DD-MON-RR'),'FULL-TIME',40);
Insert into EMPLOYEE (EMPLOYEEID,FIRSTNAME,LASTNAME,PAYRATE,HOMEPHONE,MOBILEPHONE,ADDRESSLINE1,ADDRESSLINE2,PROVINCE,CITY,POSTCODE,SKILLLEVEL,STARTDATE,ENDDATE,DOB,CONTRACTTYPE,WEEKLYHOURS) values (9,'Jim','Willfixit',8.72,'472894732','473897243987','12 Fiix It Street',null,'Staffordshire','Lichfield','L89 8ED',1,to_date('27-DEC-19','DD-MON-RR'),null,to_date('01-JAN-90','DD-MON-RR'),'PART-TIME',16);
Insert into EMPLOYEE (EMPLOYEEID,FIRSTNAME,LASTNAME,PAYRATE,HOMEPHONE,MOBILEPHONE,ADDRESSLINE1,ADDRESSLINE2,PROVINCE,CITY,POSTCODE,SKILLLEVEL,STARTDATE,ENDDATE,DOB,CONTRACTTYPE,WEEKLYHOURS) values (10,'John','Snow',8.2,'9743829788','78979879838','1 Wall Street',null,'Warwickshire','Warwick','WS18 8DF',1,to_date('28-DEC-19','DD-MON-RR'),null,to_date('01-JAN-97','DD-MON-RR'),'CONTRACTOR',8);
...
INSERT INTO ROLE VALUES ('2', 'Senior Developer', 'Expert Dev',1);
INSERT INTO ROLE VALUES ('3', 'Developer', 'Passed Training',1);
INSERT INTO ROLE VALUES ('4', 'Junior', 'New Developer',1);
INSERT INTO ROLE VALUES ('5', 'Intern', 'New to devolopment',0);
INSERT INTO ROLE VALUES ('6', 'Department Manager', 'Responsible for managing departments',0);
