...
Insert into PROJECTHOURS (STARTEDWORKING,FINISHEDWORKING,FK_TASKID,FK_PROJECTID,FK_EMPLOYEEID) values (to_timestamp('03-JUN-20 16.29.48.101000000','DD-MON-RR HH24.MI.SSXFF'),to_timestamp('03-JUN-20 17.29.52.680000000','DD-MON-RR HH24.MI.SSXFF'),1,1,1);
Insert into PROJECTHOURS (STARTEDWORKING,FINISHEDWORKING,FK_TASKID,FK_PROJECTID,FK_EMPLOYEEID) values (to_timestamp('01-JUN-20 15.30.37.251000000','DD-MON-RR HH24.MI.SSXFF'),to_timestamp('01-JUN-20 16.30.53.543000000','DD-MON-RR HH24.MI.SSXFF'),2,1,2);
