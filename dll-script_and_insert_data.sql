...
Insert into PROJECTHOURS (HOURSWORKED,FK_TASKID,FK_PROJECTID,FK_EMPLOYEEID) values (1, to_date('14-MAY-20','DD-MON-RR'), 1, 1, 1);
Insert into PROJECTHOURS (HOURSWORKED,FK_TASKID,FK_PROJECTID,FK_EMPLOYEEID) values (2, to_date('16-MAY-20','DD-MON-RR'), 2, 1, 2);
